"""Django settings for the Task Service.

Owns tasks and task history, and is the authority for the task workflow.
"""
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("TASK_DB_NAME", "task_db"),
...
LOGGING = {
    ...
    "formatters": {
        "standard": {
            "format": (
                "%(asctime)s %(levelname)s [task-service] "
